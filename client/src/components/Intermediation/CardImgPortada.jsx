...
export const CardImgPortada = () => {
  return (
    <div className='container d-flex justify-content-center d-felx align-items-center'>
          ...
          <div className="card h-100 rounded-0 border border-0 bg-transparent ">
            <div className="card-body  px-4 ">
              ...
              <div className="col-md-3 border border-0 d-flex justify-content-start align-items-center">
                <a href="#" className="btn bg-warning text-white fw-semibold fs-5 z-1 rounded-0 ">Contactanos</a>
              </div>
      ...
      <div className='position-absolute bg-danger d-none d-md-block d-lg-block d-xl-block shadow' style={{width:'40px', height:'40px',top:'390px', left:'60px', clipPath: 'polygon(0% 0%, 0% 0%, 100% 100%, 0% 100%)'}}>
      </div>
